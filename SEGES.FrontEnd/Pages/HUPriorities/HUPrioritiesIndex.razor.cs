...
{
    public partial class HUPrioritiesIndex
    {
        ...
        private async Task<bool> LoadListAsync(int page)
        {
            ...
            huPriorities = responseHttp.Response;
            return true;
        }
        ...
        public async Task DeleteAsync(HUPriority priority)
        {
            ...
            {
                Title = "Confirmación",
                Text = $"¿Estas seguro de querer borrar el estado: {priority.Name}?",
            ...
            var responseHttp = await Repository.DeleteAsync<HUPriority>($"api/HUPriorities/{priority.PriorityId}");
            if (responseHttp.Error)
            {
