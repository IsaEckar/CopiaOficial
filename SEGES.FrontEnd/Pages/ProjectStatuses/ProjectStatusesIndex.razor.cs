...
namespace SIEGES.Frontend.Pages.States
{
    public partial class StatesDetails
    {
        ...
        private async Task<bool> LoadListAsync(int page)
        {
            ...
            ProjectStatuses = responseHttp.Response;
            return true;
        }
        ...
        public async Task DeleteAsync(ProjectStatus projectStatus)
        {
            ...
            var responseHttp = await Repository.DeleteAsync<ProjectStatus>($"api/projectstatuses/{projectStatus.ProjectStatusId}");
            if (responseHttp.Error)
            {
