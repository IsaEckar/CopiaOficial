...
{
    public partial class HUPublicationStatusIndex
    {
        ...
        private async Task<bool> LoadListAsync(int page)
        {
            ...
            PublicationStatuses = responseHttp.Response;
            return true;
        }
        ...
        public async Task DeleteAsync(HUPublicationStatus publicationStatus)
        {
            var result = await SweetAlertService.FireAsync(new SweetAlertOptions
            {
                Title = "Confirmación",
                Text = $"¿Estas seguro de querer borrar el estado: {publicationStatus.Name}?",
            ...
            var responseHttp = await Repository.DeleteAsync<HUApprovalStatus>($"api/HUApprovalStatus/{publicationStatus.HUPublicationStatusId}");
            if (responseHttp.Error)
            {
